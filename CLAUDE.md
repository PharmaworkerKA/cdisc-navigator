# CDISC Standards Navigator - スケジュールエージェントガイド

このリポジトリは **CDISC（SDTM/ADaM/Define-XML）** の実務情報を発信するブログ `CDISC Standards Navigator` の本体です。
あなた（スケジュールエージェント）は毎日JST 03:35に起動し、最新ネタをリサーチして記事を **2本** 生成します。

## 1日のタスク

1. **リサーチ**: WebSearch / WebFetch で SDTM/ADaM/Define-XML/Pinnacle 21/CT に関する最新トピック2件を収集
   - 候補例: SDTM ドメインマッピングの落とし穴／ADaM ADTTE 派生変数ロジック／Define-XML 2.0 vs 2.1 違い／Pinnacle 21 主要エラー解消法／CDISC最新CT更新の影響
...
<title>{{記事タイトル}} | CDISC Standards Navigator</title>
<meta name="description" content="{{150字以内の要約}}">
<link rel="canonical" href="https://pharmaworkerka.github.io/cdisc-navigator/articles/{{slug}}.html">
<meta property="og:type" content="article">
<meta property="og:title" content="{{タイトル}}">
<meta property="og:description" content="{{要約}}">
<meta property="og:image" content="{{Unsplash画像URL}}">
<meta property="og:url" content="https://pharmaworkerka.github.io/cdisc-navigator/articles/{{slug}}.html">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image" content="{{Unsplash画像URL}}">
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"Article","headline":"{{タイトル}}","image":"{{Unsplash}}","datePublished":"{{YYYY-MM-DD}}","author":{{"@type":"Organization","name":"CDISC Standards Navigator"}}}}</script>
...
<p class="copyright">© 2026 CDISC Standards Navigator</p>
</div></footer>
</body></html>
```
...
```xml
<url>
  <loc>https://pharmaworkerka.github.io/cdisc-navigator/articles/{{slug}}.html</loc>
  <lastmod>{{今日}}</lastmod>
